          ...
          <div className="grid grid-cols-12 flex justify-between  relative contact-row">
            <div className="col-span-6 relative z-[99]">
              <div className="contact-hd-area">
                ...
                <h4>
                  knowledge with our <span className="yello-text">FAQ's</span>{" "}
                </h4>
            ...
            <div className="col-span-6">
              <div className="contact-hd-area form-area">
                <h3>Having Trouble Finding What You Need?</h3>
              </div>
              <form className="contact-form">
                ...
                <div class="inner-btn-area skil-btn">
                  <div class="inner-text-btn">Send Now</div>
                  <div class="arrow-icon-area">
