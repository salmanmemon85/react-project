        ...
        <div className='grid grid-cols-10 flex justify-center items-center '>
            ...
            <div className='grid grid-cols-12 flex justify-between'>
                <div className='col-span-4'>
                    <div className='footer-phone-area'>
                      ...
                      <i class="fa-solid fa-phone"></i>
                       <span>+919966436693</span> </a>      
                    </div>
                    <div className='footer-phone-area'>
                      <a href='#'>
                      <i class="fa-regular fa-envelope"></i>
                       <span>admin@skillcompute.com</span> </a>      
                    </div>
                ...
                <div className='col-span-3'>
                    <div className='footer-phone-area'>
                      <p >Get Directions</p>
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13026967.38926922!2d-106.25428513633595!3d37.142902825634486!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited%20States!5e0!3m2!1sen!2s!4v1691191688164!5m2!1sen!2s" width="390" height="200"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
